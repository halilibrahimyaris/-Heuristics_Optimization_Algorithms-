...
public class Individual {
     ...
     int fitness; // Store the fitness value of this individual, for this problem fitness value store the number of 1's count
     int [] chromosome; // Store the each gene of the chromosome
